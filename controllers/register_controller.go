...
func (this *RegisterController) Post() {
	...
	schoolname := this.GetString("schoolname")
	fmt.Println(username, password, repassword, schoolname)
	...
	user := models.User{1,username,password,0,schoolname,time.Now().Unix()}
